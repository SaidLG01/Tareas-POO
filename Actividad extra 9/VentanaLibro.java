...
public class VentanaLibro extends JFrame {
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(138, 240, 243));
        lblId = new JLabel("Id:");
        ...
        panel2.setBackground(new Color(165, 229, 103));
        ...
        panel3.setBackground(new Color(236, 219, 136));


        //panel4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(225, 70, 83));
